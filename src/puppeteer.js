...
let evl = require("../src/api/event-listener.js");
...
if (follow.numbersLikes < 2000) {
  console.log("number of likes is not exceed ");
  console.log("number of like is : " + follow.numbersLikes);
  ...
  let run = async () => {
    ...
    for (let index = 0; index < followingInfluencer.length; index++) {
      await page.goto(
        "https://www.instagram.com/" + followingInfluencer[index]
      );
      console.log(
    ...
    for (let index = 0; index < followersInfluencer.length; index++) {
      await page.goto(
        "https://www.instagram.com/" + followersInfluencer[index]
      );
      console.log(
